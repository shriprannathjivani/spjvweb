  ...
  return (
    <section className="relative py-10 sm:py-20 sm:p-0 pt-0">
      <Image
        ...
        width={40}
        alt="halfflower"
        className="absolute top-1 right-0 z-0 motion-safe:animate-wiggle w-[70px] h-auto
                ...
                >
                  ...
                  <div className="h-full rounded-3xl bg-white p-8 flex flex-col items-center text-center cardCustome">
                    <div className="bg-white rounded-3xl transition duration-300">
                      ...
                      <p
                        className={`text-gray-700 mb-4 text-muted-foreground transition-all duration-300 ${
