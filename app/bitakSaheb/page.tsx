...
export default function Faq() {
  ...
  return (
    <section className="max-w-370 relative  mx-auto px-4 lg:px-8 py-10 pt-0  font-arya ">
      ...
      {/* Desktop VIEW */}
      <div className="mx-auto mt-[-140] hidden lg:block">
      ...
      {/* MOBILE VIEW */}
      <div className="lg:hidden space-y-4  mt-[-140]">
