...
export default function Page() {
  ...
  /* LOAD DATA */
  useEffect(() => {
    fetch(`${basePath}/allvani/bitaksaheb.txt`)
      .then((r) => r.text())
      .then((t) => {
        ...
        <div className="max-w-7xl  mx-auto  px-6 py-6 pb-0">
          <Breadcrumb className="mb-4">
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbLink >श्री बीतक साहेब खोज</BreadcrumbLink>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
                ...
                <div className="space-y-4">
                  {results.map((r, i) => (
                    ...
                    >
                      ...
                      <p
                        className="text-xl border-b pb-3 leading-loose tracking-[0.01em]"
