...
export default function Dashboard() {
  ...
  const cards = [
    ...
    {
      title: "श्री सागर खोज",
      desc: `अब आप "श्री सागर साहेब" चौपाई को खोज सकते हैं या सभी अध्याय पढ़ सकते हैं।`,
      image: "/ic_book_search.png",
      link: "/sagarsearch",
    },
    {
      title: "श्री सिंगार खोज",
      desc: `अब आप "श्री सिंगार साहेब" चौपाई को खोज सकते हैं या सभी अध्याय पढ़ सकते हैं।`,
