      ...
      <section className="mx-auto max-w-7xl px-6 py-20 pt-32">
        ...
        <div className="">
          <h2 className="text-4xl flex flex-row font-semibold tracking-tight text-balance text-gray-900 sm:text-5xl">
            <TextAnimate animation="blurInUp" startOnView delay={0.1}>
              गेम्स&nbsp;
            </TextAnimate>{"  "}
            <span className="text-orange-500">
              <TextAnimate animation="blurInUp" startOnView delay={0.2}>
                & क्विज़
              </TextAnimate>
            </span>
          </h2>
            ...
            <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8 mb-16">
              ...
              <ul className="space-y-3 text-xl text-gray-500">
                <li className="space-y-3">
                  <TextAnimate animation="blurInUp" by="line"
                    delay={0.5}
                    segmentClassName="p" startOnView className="text-xl text-orange-900 mt-0 mb-">
